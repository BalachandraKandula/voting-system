...
def AdminHome(root,frame1,frame3):
    ...
    #Show Votes
    showVotes = Button(frame1, text="Show Votes", width=30, command = lambda: adFunc.showVotes(root, frame1))
    ...
    showVotes.grid(row = 9, column = 1, columnspan = 2)
    # reset.grid(row = 11, column = 1, columnspan = 2)
